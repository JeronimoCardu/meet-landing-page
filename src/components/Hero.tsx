...
export default function Hero() {
  return (
    <header>
      ...
      <main className="flex justify-between gap-[2em] my-[4em] text-center">
        <img
          className={`imgMobile imgHeroComplete`}
          src={peopleComplete}
          alt="people"
        />
        <img className={`imgHeroLeft`} src={peopleLeft} alt="people" />
        <div className="w-[27em] h-[19.625em] flex flex-col justify-between">
          ...
          <div className="flex gap-[1.0625em] justify-center">
            ...
            <button className="bg-[#855FB1] text-white w-[10.0625em] h-[3.5em] rounded-full">
              What is it?
            </button>
          </div>
        </div>
